...
$APPLICATION->IncludeComponent("bitrix:sale.basket.basket", "fly", array(
	...
	"PICTURE_WIDTH" => "70",
	"PICTURE_HEIGHT" => "70",
	"PATH_TO_BASKET" => CTires2::GetFrontParametrValue("BASKET_PAGE_URL"), 
	"PATH_TO_ORDER" => CTires2::GetFrontParametrValue("ORDER_PAGE_URL"), 
	"PATH_TO_AUTH" => SITE_DIR."auth/",
	"PATH_TO_COMPARE" => CTires2::GetFrontParametrValue("COMPARE_PAGE_URL"),
