				...
				<div id="blg-comment-<?=$comment["ID"]?>" class="font-size-base">
					<div class="row">
						<div class="col-auto d-none d-sm-block text-center">
							...
							{
								?>
								<div class="blog-author-acronym" style="background-color:#<?=stringToColorCode($comment['AuthorName']);?>"><?=implode('', array_map(function($v) { return substr($v, 0, 1); }, explode(' ', $comment['AuthorName'])));?></div>
								<?
							}
							?>
						</div>
