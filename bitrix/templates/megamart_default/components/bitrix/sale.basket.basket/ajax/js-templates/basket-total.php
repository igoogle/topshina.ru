		...
		<div class="simple-basket-total__buttons">
			<div class="d-flex justify-content-between align-items-center">
				...
				<div class="text-right">
					<a href="<?=SITE_DIR?>buy1click/" class="btn btn-outline-secondary" data-entity="basket-buy1click-button"><?=Loc::getMessage('SBB_BUY1CLICK')?></a>
					<a href="<?=$arParams['PATH_TO_ORDER']?>" class="btn btn-primary" data-entity="basket-checkout-button"><?=Loc::getMessage('SBB_ORDER')?></a>
				</div>
			</div>
		</div>
	</div>
