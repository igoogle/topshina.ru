	    ...
	    _createClass(Compact, [{
	      ...
	      value: function fixing() {
	        ...
	        var fixing = function fixing() {
	          if (!_this5.isFixing) {
	            var checkScroll = isDesktop() ? $(window).scrollTop() >= 200 : $(window).scrollTop() >= _this5.$element.offset().top;
	            ...
	            var _checkScroll = isDesktop() ? $(window).scrollTop() < 200 : $(window).scrollTop() < _this5.$element.parent().offset().top;
