...
<?
	...
	$rsSections = CIBlockSection::GetList(Array("SORT"=>"ASC"), array("IBLOCK_ID" => $arResult["SECTION_MAIN"]["IBLOCK_ID"], "ID"=>$arResult["SECTION_MAIN"]["ID"]),false, array("ID","IBLOCK_ID","IBLOCK_SECTION_ID","NAME","DESCRIPTION","UF_*"));
