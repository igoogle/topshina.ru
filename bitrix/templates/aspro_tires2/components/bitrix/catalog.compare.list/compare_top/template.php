...
<!--noindex-->
	...
	<a class="basket-link compare  <?=$arParams["CLASS_LINK"];?> <?=$arParams["CLASS_ICON"];?> <?=($count ? 'basket-count' : '');?>" href="<?=$arParams["COMPARE_URL"]?>" title="<?=\Bitrix\Main\Localization\Loc::getMessage('CATALOG_COMPARE_ELEMENTS_ALL');?>">
		<span class="js-basket-block"><?=CTires2::showIconSvg("compare ".$arParams["CLASS_ICON"], SITE_TEMPLATE_PATH."/images/svg/Comparison".$type_svg."_black.svg");?><span class="title dark_link"><?=\Bitrix\Main\Localization\Loc::getMessage('CATALOG_COMPARE_ELEMENTS');?></span><span class="count"><?=$count;?></span></span>
	</a>
