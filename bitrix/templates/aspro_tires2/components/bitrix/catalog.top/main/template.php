	...
	<li id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="catalog_item visible">
		<div class="inner_wrap">
			<div class="image_wrapper_block">
				<?if($arItem["PROPERTIES"][$arParams["STIKERS_PROP"]]["VALUE"] || ($arParams["SALE_STIKER"] && $arItem["PROPERTIES"][$arParams["SALE_STIKER"]]["VALUE"])){?>
					<div class="stickers">
						<?if($arItem["PROPERTIES"][$arParams["STIKERS_PROP"]]["VALUE"]):?>
