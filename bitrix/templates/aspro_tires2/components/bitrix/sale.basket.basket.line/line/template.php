...
{*/
	...
	$title_basket =  ($arResult['NUM_PRODUCTS'] ? GetMessage("BASKET_COUNT", array("#PRICE#" => CTires2::clearFormatPrice($arResult['TOTAL_PRICE']))) : GetMessage("EMPTY_BLOCK"));
	$title_delay = ($sDelayPrice ? GetMessage("BASKET_DELAY_COUNT", array("#PRICE#" => CTires2::clearFormatPrice($sDelayPrice))) : GetMessage("EMPTY_BLOCK"));
