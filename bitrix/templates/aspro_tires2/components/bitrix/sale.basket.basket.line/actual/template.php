...
$title_basket =  ($arResult['NUM_PRODUCTS'] ? Loc::getMessage("BASKET_COUNT", array("#PRICE#" => CTires2::clearFormatPrice($arResult['TOTAL_PRICE']))) : Loc::getMessage("EMPTY_BLOCK_BASKET"));
$title_delay = ($sDelayPrice ? Loc::getMessage("BASKET_DELAY_COUNT", array("#PRICE#" => CTires2::clearFormatPrice($sDelayPrice))) : Loc::getMessage("EMPTY_BLOCK_DELAY"));
