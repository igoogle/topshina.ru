<?
CTires2::getFieldImageData($arResult, array('DETAIL_PICTURE'));
...
{
	$arCompany = CTires2Cache::CIBLockElement_GetList(array('CACHE' => array('MULTI' =>'N', 'TAG' => CTires2Cache::GetIBlockCacheTag($arResult['PROPERTIES']['LINK_COMPANY']['LINK_IBLOCK_ID']))), array('IBLOCK_ID' => $arResult['PROPERTIES']['LINK_COMPANY']['LINK_IBLOCK_ID'], 'ACTIVE'=>'Y', 'ID' => $arResult['DISPLAY_PROPERTIES']['LINK_COMPANY']['VALUE']), false, false, array('ID', 'NAME', 'PREVIEW_TEXT', 'PREVIEW_TEXT_TYPE', 'DETAIL_TEXT', 'DETAIL_TEXT_TYPE', 'PREVIEW_PICTURE', 'DETAIL_PICTURE', 'DETAIL_PAGE_URL', 'PROPERTY_SITE', 'PROPERTY_SLOGAN'));
	if($arCompany){
...
$arResult['DISPLAY_PROPERTIES_FORMATTED'] = \Aspro\Functions\CAsproTires2::prepareItemProps($arResult['DISPLAY_PROPERTIES']);
