								...
								<tr class="item" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
									...
									<td colspan="<?=($imageSrc ? 1 : 2);?>" class="hidden-xs" <?=(($arResult['ITEMS_HAS_IMG'] && !$imageSrc) ? 'colspan=2' : '');?>>
											...
											<div class="muted">
												<?foreach($arItem['PROPERTIES']['METRO']['VALUE'] as $metro):?>
													<div class="icons-text metro1">
														<i class="fa"><?=CTires2::showIconSvg("metro", SITE_TEMPLATE_PATH."/images/svg/Metro.svg");?></i>
										...
										<?if($arItem['PROPERTIES']['SCHEDULE']['VALUE']):?>
											<div class="muted">
												<div class="icons-text schedule grey s25">
													<i class="fa"><?=CTires2::showIconSvg("clock", SITE_TEMPLATE_PATH."/images/svg/WorkingHours.svg");?></i> <div class="text"><?=$arItem['PROPERTIES']['SCHEDULE']['~VALUE']['TEXT'];?></div>
												</div>
											</div>
										<?endif;?>
										<?if($arItem['PROPERTIES']['EMAIL']['VALUE']):?>
											<div class="muted">
												<div class="icons-text schedule grey s25">
													<i class="fa"><?=CTires2::showIconSvg("email", SITE_TEMPLATE_PATH."/images/svg/Email.svg");?></i> <div class="text"><a href="mailto:<?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?>"><?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?></a></div>
												</div>
											</div>
										<?endif;?>
													...
													*/?>
													<?if($arItem['PROPERTIES']['METRO']['VALUE']):?>
														<div class="muted">
															<?foreach($arItem['PROPERTIES']['METRO']['VALUE'] as $metro):?>
																<div class="icons-text metro1">
																	<i class="fa"><?=CTires2::showIconSvg("metro colored", SITE_TEMPLATE_PATH."/images/svg/Metro.svg");?></i>
																	<div class="text"><?=$metro;?></div>
																</div>
															<?endforeach;?>
														</div>
													...
													<?if($arItem['PROPERTIES']['SCHEDULE']['VALUE']):?>
														<div class="muted">
															<div class="icons-text schedule grey s25">
																<i class="fa"><?=CTires2::showIconSvg("clock colored", SITE_TEMPLATE_PATH."/images/svg/WorkingHours.svg");?></i> <div class="text"><?=$arItem['PROPERTIES']['SCHEDULE']['~VALUE']['TEXT'];?></div>
															</div>
														</div>
													<?endif;?>
													<?if($arItem['PROPERTIES']['EMAIL']['VALUE']):?>
														<div class="muted">
															<div class="icons-text schedule grey s25">
																<i class="fa"><?=CTires2::showIconSvg("email colored", SITE_TEMPLATE_PATH."/images/svg/Email.svg");?></i> <div class="text"><a href="mailto:<?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?>"><?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?></a></div>
															</div>
														</div>
													<?endif;?>
													<?if($arItem['DISPLAY_PROPERTIES']):?>
