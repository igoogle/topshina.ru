	...
	<div class="items row">
		<?foreach($arResult["ITEMS"] as $i => $arItem):?>
			...
			<?ob_start();?>
				...
				<?if(isset($arItem['PROPS_FORMAT']) && $arItem['PROPS_FORMAT']):?>
					<hr />
				...
				<?if($bDetailLink):?>
					<div class="link-block-more">
						<a href="<?=$arItem['DETAIL_PAGE_URL']?>" <?=(strpos($arItem['DETAIL_PAGE_URL'], 'http') !== false ? 'target="_blank"' : "")?> class="btn btn-default white"><?=GetMessage('TO_ALL')?></a>
					</div>
				<?endif;?>
