					...
					<div class="inner_wrap">
						<div class="image_wrapper_block shine">
							...
							<?if($arParams["DISPLAY_WISH_BUTTONS"] != "N" || $arParams["DISPLAY_COMPARE"] == "Y"):?>
								<div class="like_icons">
									<?if($arParams["DISPLAY_WISH_BUTTONS"] == "Y" && !$arItem["OFFERS"]):?>
										<div class="wish_item_button" <?=(CTires2::checkShowDelay($arParams, $totalCount, $arItem) ? '' : 'style="display:none"');?>>
							...
							<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb">
								...
								<?else:?>
									<img class="noborder" src="<?=$arItem["NO_IMAGE_PATH"];?>" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
								<?endif;?>
						...
						<div class="footer_button">
							<div class="counter_wrapp">
								<div class="button_block">
									<!--noindex-->
										<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="btn btn-default basket read_more"><?=\Bitrix\Main\Config\Option::get('aspro.tires2', "EXPRESSION_READ_MORE_OFFERS_DEFAULT", GetMessage("CATALOG_READ_MORE"));?></a>
									<!--/noindex-->
								</div>
							</div>
						</div>
