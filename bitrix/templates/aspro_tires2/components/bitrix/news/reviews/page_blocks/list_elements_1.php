	...
	<table class="order-block reviews">
		<tr>
			...
			<td class="col-md-3 col-sm-4 col-xs-5 valign">
				<div class="btns">
					<button class="btn btn-default btn-lg animate-load" data-event="jqm" data-name="resume" data-param-form_id="SEND_REVIEW"><?=(strlen($arParams['S_FEEDBACK']) ? $arParams['S_FEEDBACK'] : GetMessage('S_FEEDBACK_REVIEW'))?></button>
				</div>
			</td>
		</tr>
	</table>
