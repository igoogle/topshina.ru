...
<?if($arParams["SHOW_LINKED_PRODUCTS"] == "Y" && strlen($arParams["LINKED_PRODUCTS_PROPERTY"])):?>
	<?if($arElement["PROPERTY_".$arParams["LINKED_PRODUCTS_PROPERTY"]."_VALUE"]):?>
		<div class="wraps goods-block with-padding block ajax_load catalog">
			...
			<?endif;?>
			<?$GLOBALS['arrProductsFilter'] = array("ID" => $arElement["PROPERTY_".$arParams["LINKED_PRODUCTS_PROPERTY"]."_VALUE"])?>
			<?
			if($arParams['STORES'])
			{
