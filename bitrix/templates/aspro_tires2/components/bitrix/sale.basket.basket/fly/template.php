		...
		<script>
			$(document).ready(function(){
				...
				$('#basket_line .basket_fly a.apply-button').click(function()
				{
					...
					$.post( arTires2Options['SITE_DIR']+'basket/', $("#basket_line .basket_fly form[name^=basket_form]").serialize(), $.proxy(
					function( data)
					{
			...
			<?if ($arParams["AJAX_MODE_CUSTOM"]=="Y"):?>
				...
				$("#basket_form").ready(function()
				{
					...
					$('form[name^=basket_form] .remove').unbind('click').click(function(e){
						...
						markProductRemoveBasket($(this).parents("tr[data-id]").attr('product-id'), $(this).parents("tr[data-id]").attr('data-id'));
						return false;
					});
					...
					$('form[name^=basket_form] .delay .wish_item').unbind('click').click(function(e){
						...
						var row = $(this).parents("tr").first();
						row.fadeTo(100 , 0.05, function() {});
						markProductDelay($(this).parents("tr[data-id]").attr('product-id'), $(this).parents("tr[data-id]").attr('data-id'));
					});
					...
					$('form[name^=basket_form] .add .wish_item').unbind('click').click(function(e){
						...
						markProductAddBasket($(this).parents("tr[data-id]").attr('product-id'), $(this).parents("tr[data-id]").attr('data-id'));
					});
				});
			<?endif;?>
		</script>
