...
<div class="module-form-block-wr registraion-page">
	...
	<?}else{?>
		<div class="form-block border_block">
			...
			<?$html = ob_get_clean();?>
			<?$bShowSocServ = (!empty(trim($html)))?>
			<div class="wrap_md">
				<div class="main_info <?=($bShowSocServ ? 'iblock with-soc-serv' : '');?>">
					<div class="top">
					...
					<script>
						$(document).ready(function(){
							...
							if(arTires2Options['THEME']['PHONE_MASK'].length){
								...
								$('form#registraion-page-form input.phone_input').inputmask('mask', {'mask': arTires2Options['THEME']['PHONE_MASK'] });
