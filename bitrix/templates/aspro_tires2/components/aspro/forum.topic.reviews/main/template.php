...
<script type="text/javascript">
	BX.ready(function(){
		...
		<?if($count_messages){?>
			$('.ajax_load .tabs .reviews_item_tab .count.empty').html('&nbsp; (<?=$count_messages;?>)');
			
			var countMessages = '<?=\Aspro\Functions\CAsproTires2::declOfNum($count_messages, array(GetMessage("ONEW_REVIEW"), GetMessage("TWO_REVIEW"), GetMessage("THREE_REVIEW")));?>';
