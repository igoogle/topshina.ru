...
<?if(!$arResult['POPUP']):?>
	<?if($arResult['CURRENT_REGION']):?>
		...
		<div class="region_wrapper">
			...
			<div class="js_city_chooser dark_link" data-event="jqm" data-name="city_chooser" data-param-url="<?=urlencode($APPLICATION->GetCurUri());?>" data-param-form_id="city_chooser">
