...
<div class="header-v12 header-wrapper">
	...
	<div class="logo_and_menu-row">
		<div class="logo-row">
			<div class="maxwidth-theme">
				<div class="row">
					<div class="burger pull-left"><?=CTires2::showIconSvg("burger dark", SITE_TEMPLATE_PATH."/images/svg/Burger_big_white.svg");?></div>
					...
					<div class="right-icons pull-right">
						<div class="pull-right">
							<div class="wrap_icon wrap_basket">
								<?=CTires2::ShowBasketWithCompareLink('', 'big');?>
							</div>
						</div>
						<div class="pull-right">
