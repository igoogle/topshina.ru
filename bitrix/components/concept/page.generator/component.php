...
$arr_resCatalog = array();

/*$arFilterCatalog = Array("IBLOCK_CODE"=> "concept_hameleon_site_catalog", "ACTIVE_DATE"=>"Y");
$resCatalog = CIBlockElement::GetList(Array("ID"=>"ASC"), $arFilterCatalog, false, false, array("ID"));


while($ar_resCatalog = $resCatalog->GetNext())
	$arr_resCatalog[] = $ar_resCatalog["ID"];*/



if($this->startResultCache(false, array($USER->GetGroups(), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter, $pagerParameters, $arr_resCatalog)))
{
