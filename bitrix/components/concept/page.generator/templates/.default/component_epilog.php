...
$string = '<meta property="og:title" content= "'.Chameleon::prepareText($arResult["SEO"]["seo_title"]).'" />';
$APPLICATION->AddHeadString($string, false, true);
   
$string = '<meta property="og:description" content= "'.Chameleon::prepareText($arResult["SEO"]["seo_desc"]).'" />';
$APPLICATION->AddHeadString($string, false, true);
...
if($arResult["SECTION"]["UF_CAPTCHA"] && isset($arResult["SECTION"]["UF_CAPTCHA_SITE_KEY"]{0}))
{
    \Bitrix\Main\Page\Asset::getInstance()->addJs('https://www.google.com/recaptcha/api.js?render='.$arResult["SECTION"]["UF_CAPTCHA_SITE_KEY"]);

    echo "<input type=\"hidden\" class=\"captcha-site-key\" value=\"".$arResult["SECTION"]["UF_CAPTCHA_SITE_KEY"]."\">";
}
...
<?if(($USER->isAdmin() || $hameleon_rights > "R") && !empty($arResult["ERRORS"])):?>

<?
    Bitrix\Main\Loader::includeModule("concept.hameleon");
                    ...
                    <div class="cont">
                        ...
                        <div class="instr">
                            ...
                            <div class="instr-element">
                                ...
                                <div class="text">1. <a href="/bitrix/admin/iblock_list_admin.php?IBLOCK_ID=<?=$HAMELEON_TEMPLATE_ARRAY['FORMS']["IBLOCK_ID"]?>&type=concept_hameleon&lang=ru&find_section_section=0" target="_blank"><?=GetMessage("PAGE_GEN_COMPEPIL_HAMELEON_ALERT_CALLBACK_TEXT_1")?></a></div>
                    ...
                    <div class="cont">
                        ...
                        <div class="instr">
                            ...
                            <div class="instr-element">
                                ...
                                <div class="text">1. <a href="/bitrix/admin/iblock_list_admin.php?IBLOCK_ID=<?=$HAMELEON_TEMPLATE_ARRAY['FORMS']["IBLOCK_ID"]?>&type=concept_hameleon&lang=ru&find_section_section=0" target="_blank"><?=GetMessage("PAGE_GEN_COMPEPIL_HAMELEON_ALERT_CATALOG_FORM_TEXT_1")?></a></div>
                    ...
                    <div class="cont">
                        ...
                        <div class="instr">
                            ...
                            <div class="instr-element">
                                ...
                                <div class="text">1. <a href="/bitrix/admin/iblock_list_admin.php?IBLOCK_ID=<?=$HAMELEON_TEMPLATE_ARRAY['FORMS']["IBLOCK_ID"]?>&type=concept_hameleon&lang=ru&find_section_section=0" target="_blank"><?=GetMessage("PAGE_GEN_COMPEPIL_HAMELEON_ALERT_CATALOG_CART_FORM_TEXT_1")?></a></div>
                                ...
                                <td class="left-p col-md-8 col-xs-12">
                                    ...
                                    <div class="wrap-adv-table">
                                        ...
                                        <div class="row">
                                            ...
                                            <?$total_count = ($arResult["CH_BOX_ADV"])?count($arResult["CH_BOX_ADV"]):0;?>
...
$lang = (strlen($arResult["SECTION"]["UF_LANG_FILE"]) > 0)?$arResult["SECTION"]["UF_LANG_FILE"]:"ru";

if(file_exists(SITE_TEMPLATE_PATH."/lang/ru/".$lang."_jquery.countdown.js"))
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/lang/ru/".$lang."_jquery.countdown.js");
else
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/lang/ru/ru_jquery.countdown.js");

if(file_exists(SITE_TEMPLATE_PATH."/lang/ru/".$lang."_jquery.datetimepicker.full.min.js"))
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/lang/ru/".$lang."_jquery.datetimepicker.full.min.js");
else
	Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/lang/ru/ru_jquery.datetimepicker.full.min.js");
...
global $compressHTML,
    ...
    $compressHTML = $arResult["SECTION"]["UF_COMPRESS_HTML"];
    $delTechFiles = $arResult["SECTION"]["UF_DEL_TECH_FILES"];
    $transferCss2Page = $arResult["SECTION"]["UF_TRANSFER_CSS2PAGE"];
...
<?
    ...
    {
        $APPLICATION->set_cookie("UTM_SOURCE_".SITE_ID, "", -1, $page, false,false,true,"hameleon");

        $APPLICATION->set_cookie("UTM_MEDIUM_".SITE_ID, "", -1, $page, false,false,true,"hameleon");

        $APPLICATION->set_cookie("UTM_CAMPAIGN_".SITE_ID, "", -1, $page, false,false,true,"hameleon");

        $APPLICATION->set_cookie("UTM_CONTENT_".SITE_ID, "", -1, $page, false,false,true,"hameleon");

        $APPLICATION->set_cookie("UTM_TERM_".SITE_ID, "", -1, $page, false,false,true,"hameleon");
    }

    if(isset($params['utm_source']))
        $APPLICATION->set_cookie("UTM_SOURCE_".SITE_ID, $params['utm_source'], time()+60*60*24*14, $page, false,false,true,"hameleon");

    if(isset($params['utm_medium']))
        $APPLICATION->set_cookie("UTM_MEDIUM_".SITE_ID, $params['utm_medium'], time()+60*60*24*14, $page, false,false,true,"hameleon");

    if(isset($params['utm_campaign']))
        $APPLICATION->set_cookie("UTM_CAMPAIGN_".SITE_ID, $params['utm_campaign'], time()+60*60*24*14, $page, false,false,true,"hameleon");

    if(isset($params['utm_content']))
        $APPLICATION->set_cookie("UTM_CONTENT_".SITE_ID, $params['utm_content'], time()+60*60*24*14, $page, false,false,true,"hameleon");

    if(isset($params['utm_term']))
        $APPLICATION->set_cookie("UTM_TERM_".SITE_ID, $params['utm_term'], time()+60*60*24*14, $page, false,false,true,"hameleon");
