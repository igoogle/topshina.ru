...
/*if(!$arResult["ELEMENT"]["UF_FORUM_TOPIC_ID"])
{
	$arFields = array(
		"FIELD_NAME" => "UF_FORUM_TOPIC_ID",
		"USER_TYPE_ID" => "string",
		"XML_ID" => "UF_FORUM_TOPIC_ID",
		"SORT" => 100,
		"MULTIPLE" => "N",
		"MANDATORY" => "N",
		"SHOW_FILTER" => "N",
	...
	$FIELD_ID = $ob->Add(array_merge($arFields, array("ENTITY_ID" => "IBLOCK_".$arResult["ELEMENT"]["IBLOCK_ID"]."_SECTION"), $arLangs));
}
if(!$arResult["ELEMENT"]["UF_FORUM_MESSAGE_CNT"])
{
	$arFields = array(
		"FIELD_NAME" => "UF_FORUM_MESSAGE_CNT",
		"USER_TYPE_ID" => "string",
		"XML_ID" => "UF_FORUM_MESSAGE_CNT",
		"SORT" => 100,
		"MULTIPLE" => "N",
		"MANDATORY" => "N",
		"SHOW_FILTER" => "N",
	...
	$arLangs = array(
		"EDIT_FORM_LABEL" => array(
			"ru" => GetMessage("FORUM_MESSAGE_CNT"),
			"en" => "FORUM_MESSAGE_CNT",
		),
		"LIST_COLUMN_LABEL" => array(
			"ru" => GetMessage("FORUM_MESSAGE_CNT"),
			"en" => "FORUM_MESSAGE_CNT",
