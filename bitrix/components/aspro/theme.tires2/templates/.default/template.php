	...
	<form method="POST" name="style-switcher">
		<div class="parametrs">
			<div class="left-block">
				<?$arParametrs = CTires2::$arParametrsList;
				$i = 0;?>
		...
		<div class="presets<?=($_COOKIE['styleSwitcherType'] === 'presets' ? ' active' : '')?>">
			<div class="options">
				<div class="rows items">
					<?$arPresets = CTires2::$arPresetsList;?>
						...
						<div class="item col-md-12 col-sm-12 col-xs-12">
							...
							<div class="preset-block link-item animation-boxs<?=($bCurrent ? ' current' : '')?><?=($arPreset['IMG'] ? '' : ' no_img')?>" data-id="<?=$arPreset['ID']?>">
								...
								<div class="info">
									...
									<span class="icon">
										<?if($bCurrent):?>
											<svg class="check_svg" xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9">
												<defs>
													<style>
													.check_svg .cls-10 {
													fill: #fff;
												...
												<path id="Rounded_Rectangle_358_copy_6" data-name="Rounded Rectangle 358 copy 6" class="cls-10" d="M639.7,158.681l-6.978,6.978c-0.012.013-.016,0.031-0.029,0.044a0.973,0.973,0,0,1-.707.289,0.986,0.986,0,0,1-.713-0.289c-0.021-.021-0.028-0.049-0.047-0.071l-2.944-2.962a1,1,0,0,1,0-1.405,0.984,0.984,0,0,1,1.4,0l2.307,2.321,6.31-6.309A0.993,0.993,0,1,1,639.7,158.681Z" transform="translate(-628 -157)"></path>
											</svg>
										<?else:?>
