...
class CBitrixMenuAsproComponent extends CBitrixComponent
{
	public function onPrepareComponentParams($arParams)
	{
		...
		/*fix to add cacheID*/
		$arParams["CACHE_PATH_EXT"] = $arParams["CACHE_PATH_EXT"];
		/**/
	...
	public function getCacheID($additionalCacheID = false)
	{
		...
		if($this->arParams["MENU_CACHE_TIME"])
		{
			...
			/*fix to add cacheID*/
			if($this->arParams["CACHE_PATH_EXT"])
				$strCacheID .= ":".$this->arParams["CACHE_PATH_EXT"];
			/**/
