...
if($arParams["SEF_MODE"] == "Y")
{
	...
	/**/
	if($arVariables["SECTION_CODE_PATH"] && strpos($arVariables["SECTION_CODE_PATH"], \Bitrix\Main\Config\Option::get("aspro.tires2", "PODBOR_ELEMENTS_URL", "search")) === false && $arParams["SEF_URL_TEMPLATES_FILTER"])
	{
		$arParams["SEF_URL_TEMPLATES"]["smart_filter"] = $arParams["SEF_URL_TEMPLATES_FILTER"];
		$arUrlTemplates = CComponentEngine::makeComponentUrlTemplates($arDefaultUrlTemplates404, $arParams["SEF_URL_TEMPLATES"]);
	...
	$arVariables["SECTION_CODE_PATH"] = str_replace("Y/", "", $arVariables["SECTION_CODE_PATH"]);
	/**/
