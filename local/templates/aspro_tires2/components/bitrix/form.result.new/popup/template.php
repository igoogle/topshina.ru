...
<div class="form <?=$arResult["arForm"]["SID"]?>">
		...
		<div class="form_footer">
			...
			<?if($bShowLicenses == "Y"):?>
				<div class="licence_block filter label_block">
					<input type="checkbox" id="licenses_popup" name="licenses_popup" <?=(COption::GetOptionString("aspro.tires2", "LICENCE_CHECKED", "N") == "Y" ? "checked" : "");?> required value="Y">
	...
	$(document).ready(function(){
		...
		if(arTires2Options['THEME']['PHONE_MASK'].length){
			...
			$('form[name=<?=$arResult["arForm"]["VARNAME"]?>] input.phone').inputmask('mask', {'mask': arTires2Options['THEME']['PHONE_MASK'] });
