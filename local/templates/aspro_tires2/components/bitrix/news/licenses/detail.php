...
$arElement = CTires2Cache::CIblockElement_GetList(array("CACHE" => array("TAG" => CTires2Cache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "N")), $arItemFilter, false, false, array("ID", 'PREVIEW_TEXT', "IBLOCK_SECTION_ID", 'DETAIL_PICTURE', 'DETAIL_PAGE_URL', 'PROPERTY_LINK_PROJECTS', 'PROPERTY_LINK_REVIEWS', 'PROPERTY_DOCUMENTS'));
?>
	...
	<?if(in_array('LINK_REVIEWS', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_LINK_REVIEWS_VALUE']):?>
		<div class="wraps reviews-block">
			...
			<?$APPLICATION->IncludeComponent("bitrix:news.list", "reviews", array(
				...
				"IBLOCK_ID" => CTires2Cache::$arIBlocks[SITE_ID]["aspro_digital_content"]["aspro_digital_reviews"][0],
				"NEWS_COUNT" => "20",
	...
	<?if(in_array('LINK_PROJECTS', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_LINK_PROJECTS_VALUE']):?>
		<div class="wraps projects-block">
			...
			<?$APPLICATION->IncludeComponent(
				...
				array(
					"IBLOCK_TYPE" => "aspro_digital_content",
					"IBLOCK_ID" => CTires2Cache::$arIBlocks[SITE_ID]["aspro_digital_content"]["aspro_digital_projects"][0],
					"NEWS_COUNT" => "20",
					"SORT_BY1" => "SORT",
					"SORT_ORDER1" => "ASC",
					"SORT_BY2" => "ID",
		...
		<div class="wraps docs-block">
			...
			<div class="row">
				<?foreach($arElement['PROPERTY_DOCUMENTS_VALUE'] as $docID):?>
					<?$arItem = CTires2::get_file_info($docID);?>
					<div class="col-md-4">
						<?
						...
						<div class="blocks clearfix <?=$arItem["TYPE"];?>">
							<div class="inner-wrapper">
								...
								<div class="filesize"><?=CTires2::filesize_format($arItem['FILE_SIZE']);?></div>
							</div>
						</div>
					</div>
				<?endforeach;?>
