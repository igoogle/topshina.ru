							...
							<?endif;?>
								...
								<?foreach($arSection['ITEMS'] as $i => $arItem):?>
									...
									<?ob_start();?>
										...
										<?endif;?>
										<?if($arParams['FORM'] == 'Y'):?>
											<button class="btn btn-default" data-event="jqm" data-name="resume" data-param-form_id="<?=$arParams["FORM_ID"]?>" data-autoload-POST="<?=CTires2::formatJsName($arItem['NAME']);?>" data-autohide=""><?=$arParams["FORM_BUTTON_TITLE"];?></button>
										<?endif;?>
