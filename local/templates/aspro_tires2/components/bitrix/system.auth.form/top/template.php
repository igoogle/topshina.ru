...
<?else:?>
	<div class="module-enter have-user">
		...
		global $USER;
		$arPhoto=array();
		$arUser=CTires2Cache::CUser_GetList(array("SORT"=>"ASC", "CACHE" => array("MULTI" => "N", "TAG"=>CTires2Cache::GetUserCacheTag($USER->GetID()))), array("ID"=>$USER->GetID()), array("FIELDS"=>array("ID", "PERSONAL_PHOTO")));
