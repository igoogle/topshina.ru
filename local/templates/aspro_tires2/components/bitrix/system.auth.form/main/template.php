						...
						<form id="avtorization-form" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arParams["AUTH_URL"]?>?login=yes">
							...
							<div class="but-r">
								<div class="filter block">
									<a class="forgot pull-right" href="<?=str_replace("registration", "forgot-password", $arResult["AUTH_FORGOT_PASSWORD_URL"]);?>" tabindex="3"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
