						...
						<div class="bx_filter_button_box active">
							<div class="bx_filter_block">
								<div class="bx_filter_parameters_box_container">
									...
									<input class="bx_filter_search_button btn btn-default <?=($arParams["INSTANT_RELOAD"] != "Y" ? "" : "hidden");?>" onclick="return sendQueryTires(this)" type="submit" name="set_filter" data-href="" value="<?=Loc::getMessage("CT_BCSF_SET_FILTER")?>" />
