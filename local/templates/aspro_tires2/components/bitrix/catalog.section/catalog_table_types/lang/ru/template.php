<?
	...
	$MESS["ITEM_TABLE_SIZE"] = "Размер";
	$MESS["ITEM_TABLE_TITLE"] = "Наименование";
	$MESS["ITEM_TABLE_PRICE"] = "Цена";
	$MESS["ITEM_TABLE_AMOUNT"] = "Наличие";
	$MESS["SECTION_ITEM_TYPES_AND_PRICE"] = "Типоразмеры и наличие";
	$MESS["SECTION_ITEM_TYPES"] = "Типоразмеры";
	$MESS["SECTION_ITEM_TYPES_ALL"] = "Все размеры";
	$MESS["SECTION_ITEM_REVIEWS"] = "Отзывы";
	$MESS["SECTION_ITEM_VIDEO"] = "Видео ";
	$MESS["SECTION_ITEM_DESCRIPTION"] = "Описание";
	$MESS["HIDE_FORM"] = "Свернуть форму";
	$MESS["ADD_REVIEW"] = "Оставить отзыв";
	$MESS["QUANTITY_TITLE"] = "Наличие: ";
?>