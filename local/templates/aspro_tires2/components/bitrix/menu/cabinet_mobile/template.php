...
<div class="menu middle">
	<ul>
		<li<?=(CTires2::isPersonalPage() ? ' class="selected"' : '')?>>
			<?$link = CTires2::GetFrontParametrValue('PERSONAL_PAGE_URL');?>
			<a rel="nofollow" class="dark-color<?=($bParent ? ' parent' : '')?>" href="<?=$link;?>">
				<?=CTires2::showIconSvg("cabinet", SITE_TEMPLATE_PATH."/images/svg/".($USER->IsAuthorized() ? 'User' : 'Lock')."_black.svg");?>
