...
if($arResult['REGIONS']):?>
	<div class="region_wrapper">
		...
		<div class="js_city_chooser dark_link list" data-param-url="<?=urlencode($APPLICATION->GetCurUri());?>" data-param-form_id="city_chooser">
			<span><span><?=$arResult['CURRENT_REGION']['NAME'];?><span class="arrow"><i></i></span></span></span>
		</div>
		<div class="dropdown">
			<div class="wrap">
