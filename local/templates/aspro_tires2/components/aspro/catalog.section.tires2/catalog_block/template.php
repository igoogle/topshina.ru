...
<?if( count( $arResult["ITEMS"] ) >= 1 ){?>
			...
			<div class="item_block col-<?=$col;?> col-md-<?=ceil(12/$col);?> col-sm-<?=ceil(12/round($col / 2))?> col-xs-6">
				<div class="catalog_item_wrapp item">
					...
					if(!$arItem["OFFERS"] || $arParams['TYPE_SKU'] !== 'TYPE_1'){
						...
						$arAddToBasketData = CTires2::GetAddToBasketArray($arItem, $totalCount, $arParams["DEFAULT_COUNT"], $arParams["BASKET_URL"], ($bLinkedItems ? true : false), $arItemIDs["ALL_ITEM_IDS"], 'small', $arParams);
					}
	...
	<?}?>
<?}elseif(!isset($arParams["SHOW_EMPTY_SECTION"]) || $arParams["SHOW_EMPTY_SECTION"] != "N"){?>
	<script>
