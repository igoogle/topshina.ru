...
if($arResult["ITEMS"])
{
	...
	{
		$arResult["ITEMS"][$key]["DISPLAY_PROPERTIES"] = \Aspro\Functions\CAsproTires2::getFormatedTIProps($arItem["DISPLAY_PROPERTIES"]);
		...
		foreach($arFormatProps as $codeProp)
		{
			...
			{
				$arResult["ITEMS"][$key]["DISPLAY_PROPERTIES"][$codeProp]["VALUE"] = round($arItem["DISPLAY_PROPERTIES"][$codeProp]["VALUE"], 1);
				$arResult["ITEMS"][$key]["DISPLAY_PROPERTIES"][$codeProp]["DISPLAY_VALUE"] = round($arItem["DISPLAY_PROPERTIES"][$codeProp]["DISPLAY_VALUE"], 1);
			}
		}
		/**/
