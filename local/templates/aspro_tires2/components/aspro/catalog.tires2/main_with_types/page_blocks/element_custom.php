...
$ElementID = $APPLICATION->IncludeComponent(
	...
	"custom",
	Array(
		"SORT_LINKED" => ($arParams["SORT_LINKED"] ? $arParams["SORT_LINKED"] : "CATALOG_PRICE_1"),
		"CUSTOM_STORES" => $arParams["CUSTOM_STORES"],
		"SORT_LINKED_ORDER" => "ASC",
		...
		'LIST_SIMILAR_PARAMS' => $arParams['LIST_SIMILAR_PARAMS'],
		'LIST_PRODUCT_BLOCKS_TAB_ORDER' => $arParams['LIST_PRODUCT_BLOCKS_TAB_ORDER'],
		...
		"FILTER_PARAMS" => $arAllValues,
		"USE_SUITABLE_CAR" => $arParams["USE_SUITABLE_CAR"],
		"TAB_SUITABLE_NAME" => $arParams["TAB_SUITABLE_NAME"],
		"TITLE_SIMILAR_PARAMS" => $arParams["TITLE_SIMILAR_PARAMS"],

		"TYRE_SHIRINA_PROFILYA" => $arTheme["PROP_TYRE_SHIRINA_PROFILYA"]["VALUE"],
		"TYRE_VYSOTA_PROFILYA" => $arTheme["PROP_TYRE_VYSOTA_PROFILYA"]["VALUE"],
		"TYRE_POSADOCHNYY_DIAMETR" => $arTheme["PROP_TYRE_POSADOCHNYY_DIAMETR"]["VALUE"],
		"DIKS_POSADOCHNYY_DIAMETR_DISKA" => $arTheme["PROP_DIKS_POSADOCHNYY_DIAMETR_DISKA"]["VALUE"],
		"DISK_SHIRINA_DISKA" => $arTheme["PROP_DISK_SHIRINA_DISKA"]["VALUE"],
		"DISK_MEZHBOLTOVOE_RASSTOYANIE" => $arTheme["PROP_DISK_MEZHBOLTOVOE_RASSTOYANIE"]["VALUE"],
		"DISK_COUNT_OTVERSTIY" => $arTheme["PROP_DISK_COUNT_OTVERSTIY"]["VALUE"],
		"AKB_LENGTH" => $arTheme["PROP_AKB_LENGTH"]["VALUE"],
		"AKB_WIDTH" => $arTheme["PROP_AKB_WIDTH"]["VALUE"],
		"AKB_HEIGHT" => $arTheme["PROP_AKB_HEIGHT"]["VALUE"],
		"AKB_EMKOST" => $arTheme["PROP_AKB_EMKOST"]["VALUE"],
		"AKB_POLARNOST" => $arTheme["PROP_AKB_POLARNOST"]["VALUE"],
		"AKB_TYPE" => $arTheme["PROP_AKB_TYPE"]["VALUE"],
		"AKB_VOLTAG" => $arTheme["PROP_AKB_VOLTAG"]["VALUE"],

		"STORE_VIEW_TYPE" => $arTheme["STORE_TYPE_CATALOG_DETAIL"]["VALUE"],
		"STORES_PARAMS" => $arParams["STORES_PARAMS"],
		"STORES_FILTER_PARAM" => $arParams["STORES_FILTER_PARAM"],
		"STORES_PARAMS_PRICE" => $arParams["STORES_PARAMS_PRICE"],
		...
		'ADD_SECTION_DETAIL_TO_SLIDER' => (isset($arParams['ADD_SECTION_DETAIL_TO_SLIDER']) ? $arParams['ADD_SECTION_DETAIL_TO_SLIDER'] : 'Y'),
		'ORDER_DETAIL_SECTION' => (isset($arParams['ORDER_DETAIL_SECTION']) ? $arParams['ORDER_DETAIL_SECTION'] : 'LAST'),
		"SHOW_EMPTY_STORE" => $arParams['SHOW_EMPTY_STORE'],
		"ADD_SECTION_DESCRIPTION" => $arParams['ADD_SECTION_DESCRIPTION'],
		"HIDE_BRAND_DESCRIPTION" => $arParams['HIDE_BRAND_DESCRIPTION'],
		...
		"BLOG_IBLOCK_ID" => (isset($arParams["BLOG_IBLOCK_ID"]) && $arParams["BLOG_IBLOCK_ID"] ? $arParams["BLOG_IBLOCK_ID"] : CTires2Cache::$arIBlocks[SITE_ID]['aspro_tires2_content']['aspro_tires2_articles'][0]),
		"IBLOCK_SERVICES_ID" => (isset($arParams["IBLOCK_SERVICES_ID"]) && $arParams["IBLOCK_SERVICES_ID"] ? $arParams["IBLOCK_SERVICES_ID"] : CTires2Cache::$arIBlocks[SITE_ID]['aspro_tires2_content']['aspro_tires2_services'][0]),

		"VISIBLE_PROP_COUNT" => ($arParams['VISIBLE_PROP_COUNT'] ? $arParams['VISIBLE_PROP_COUNT'] : 5),
