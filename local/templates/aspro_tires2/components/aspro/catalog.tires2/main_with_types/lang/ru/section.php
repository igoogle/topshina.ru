<?
	...
	$MESS["PODBOR"] = "Подбор";
	$MESS["RECOMEND_MODEL"] = "Рекомендуют";

	$MESS["SECTIONS_MODEL_ITEM"] = "Модели шин";
	$MESS["SECTIONS_MODELD_ITEM"] = "Модели дисков";
	$MESS["SECTIONS_MODELA_ITEM"] = "Модели акб";
	$MESS["SECTIONS_ALL_ITEM"] = "Все шины";
	$MESS["SECTIONS_ALLD_ITEM"] = "Все диски";
	$MESS["SECTIONS_ALLA_ITEM"] = "Все акб";
	$MESS["SECT_DISPLAY_BLOCK"] = "плиткой";
	$MESS["SECT_DISPLAY_LIST"] = "списком";
?>