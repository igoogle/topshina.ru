...
$arProperty_S = $arProperty_XL = $arProperty_LNS = $arPropertyNM_LNS = array();
$arProperty_LNS[] = "-";
if (0 < intval($arCurrentValues['IBLOCK_ID']))
{
	...
	while ($arr=$rsProp->Fetch())
	{
		...
		if(($arr["PROPERTY_TYPE"] == "L" && $arr["MULTIPLE"] != "Y") || $arr["PROPERTY_TYPE"] == "N" || $arr["PROPERTY_TYPE"] == "S")
			$arProperty_LNS[$arr["CODE"]] = "[".$arr["CODE"]."] ".$arr["NAME"];
	}
	$arPropertyNM_LNS = $arProperty_LNS;
	unset($arPropertyNM_LNS[0]);
}
...
if(\Bitrix\Main\Loader::includeModule('aspro.tires2')){
	...
	CTires2::AddComponentTemplateModulePageBlocksParams(__DIR__, $arPageBlocksParams, array('SECTION' => 'CATALOG_PAGE', 'OPTION' => 'CATALOG')); // add option value FROM_MODULE
...
$arTemplateParametersParts[] = array_merge($arPageBlocksParams,array(
	"DEFAULT_LIST_TEMPLATE" => Array(
			...
			"TYPE" => "LIST",
			"VALUES" => array("block"=>GetMessage("DEFAULT_LIST_TEMPLATE_BLOCK"), "list"=>GetMessage("DEFAULT_LIST_TEMPLATE_LIST")),
			"DEFAULT" => "list",
			"PARENT" => "LIST_SETTINGS",
	),
	...
	"ADD_SECTION_DETAIL_TO_SLIDER" => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('CP_BC_TPL_ADD_SECTION_DETAIL_TO_SLIDER'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y'
	),
	"ADD_SECTION_DESCRIPTION" => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('CP_BC_TPL_ADD_SECTION_DESCRIPTION'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N'
	),
	"HIDE_BRAND_DESCRIPTION" => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('CP_BC_TPL_HIDE_BRAND_DESCRIPTION'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N'
	),
	"ORDER_DETAIL_SECTION" => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('CP_BC_TPL_ORDER_DETAIL_SECTION'),
		'TYPE' => 'LIST',
		'VALUES' => array(
			"LAST" => GetMessage('CP_BC_TPL_ORDER_DETAIL_SECTION_LAST'),
			"AFTER_DETAIL" => GetMessage('CP_BC_TPL_ORDER_DETAIL_SECTION_AFTER_DETAIL'),
		),
		'DEFAULT' => 'LAST'
	),
...
$arTemplateParametersParts[] = Array(
	...
	"SHOW_SUBSECTION_PREVIEW_PROPERTY" => array(
		"NAME" => GetMessage("SHOW_SUBSECTION_PREVIEW_PROPERTY"),
		"VALUES" => array_merge(array("DESCRIPTION"=>GetMessage("SHOW_SECTION_PREVIEW_PROPERTY_DESCRIPTION")), $arUserFields_S),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
	...
	"AJAX_FILTER_ITEM" => Array(
		"NAME" => GetMessage("AJAX_FILTER_ITEM"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "N",
		"PARENT" => "LIST_SETTINGS",
	),
	"SECTION_LINE_ELEMENT" => Array(
		"NAME" => GetMessage("SECTION_LINE_ELEMENT"),
		"TYPE" => "LIST",
		"DEFAULT" => "2",
	...
	"USE_SUITABLE_CAR" => Array(
		"NAME" => GetMessage("T_USE_SUITABLE_CAR"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y",
		"REFRESH" => "Y",
		"PARENT" => "DETAIL_SETTINGS",
	),
	"TAB_SUITABLE_NAME" => Array(
		"NAME" => GetMessage("T_TAB_SUITABLE_NAME"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "DETAIL_SETTINGS",
		"HIDDEN" => (isset($arCurrentValues['USE_SUITABLE_CAR']) && $arCurrentValues['USE_SUITABLE_CAR'] == 'N' ? 'Y' : 'N')
	),
	"USE_SIMILAR_PARAMS" => Array(
		"NAME" => GetMessage("T_USE_SIMILAR_PARAMS"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "Y",
		"REFRESH" => "Y",
		"PARENT" => "DETAIL_SETTINGS",
	),
	"TITLE_SIMILAR_PARAMS" => Array(
		"NAME" => GetMessage("T_TITLE_LIST_SIMILAR_PARAMS"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "DETAIL_SETTINGS",
		"HIDDEN" => (isset($arCurrentValues['USE_SIMILAR_PARAMS']) && $arCurrentValues['USE_SIMILAR_PARAMS'] == 'N' ? 'Y' : 'N')
	),
	"LIST_SIMILAR_PARAMS" => Array(
		"NAME" => GetMessage("T_LIST_SIMILAR_PARAMS"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
		"ADDITIONAL_VALUES" => "N",
		"DEFAULT" => "",
		"PARENT" => "DETAIL_SETTINGS",
		"VALUES" => $arPropertyNM_LNS,
		"HIDDEN" => (isset($arCurrentValues['USE_SIMILAR_PARAMS']) && $arCurrentValues['USE_SIMILAR_PARAMS'] == 'N' ? 'Y' : 'N')
	),
	"SORT_TAB_BUTTONS" => Array(
		"SORT" => 100,
		"NAME" => GetMessage("T_SORT_BUTTONS_TABS"),
		"TYPE" => "LIST",
		"VALUES" => array("POPULARITY"=>GetMessage("SORT_BUTTONS_POPULARITY"), "SORT"=>GetMessage("SORT_BUTTONS_SORT"), "NAME"=>GetMessage("SORT_BUTTONS_NAME"), "PRICE"=>GetMessage("SORT_BUTTONS_PRICE")/*, "QUANTITY"=>GetMessage("SORT_BUTTONS_QUANTITY")*/),
		"DEFAULT" => array("PRICE"),
		"PARENT" => "DETAIL_SETTINGS",
		"TYPE" => "LIST",
		"REFRESH" => "Y",
	...
	"SORT_TAB_BUTTONS_ORDER" => Array(
		"NAME" => GetMessage("STORES_FILTER_ORDER_TITLE"),
		"TYPE" => "LIST",
		"DEFAULT" => "SORT_ASC",
		"VALUES" => array(
			"asc" => GetMessage("STORES_FILTER_ORDER_ASC_TITLE"),
			"desc" => GetMessage("STORES_FILTER_ORDER_DESC_TITLE"),
		),
		"PARENT" => "DETAIL_SETTINGS",
	),
	"SORT_TAB_PRICES" => Array(
		"SORT"=>200,
		"NAME" => GetMessage("SORT_PRICES"),
		"TYPE" => "LIST",
		"VALUES" => $arPrice,
		...
		"PARENT" => "DETAIL_SETTINGS",
		"MULTIPLE" => "N",
		"HIDDEN" => (isset($arCurrentValues['SORT_TAB_BUTTONS']) && $arCurrentValues['SORT_TAB_BUTTONS'] != 'PRICE' ? 'Y' : 'N')
	),
	"SORT_TAB_REGION_PRICE" => Array(
		"SORT"=>200,
		"NAME" => GetMessage("SORT_REGION_PRICE"),
		"TYPE" => "LIST",
		"VALUES" => $arRegionPrice,
...
$arTemplateParametersParts[] = Array(
	...
	"IBLOCK_SERVICES_ID" => Array(
		"NAME" => GetMessage("IBLOCK_SERVICES_ID_TITLE"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "DETAIL_SETTINGS",
	),
	"IBLOCK_STOCK_ID" => Array(
		"NAME" => GetMessage("IBLOCK_STOCK_ID_TITLE"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "DETAIL_SETTINGS",
	),
	...
	"STORES_FILTER_PARAM" => Array(
		"NAME" => GetMessage("STORES_FILTER_PARAM_TITLE"),
		"TYPE" => "LIST",
		"DEFAULT" => "STORE",
		"VALUES" => array(
			"STORE" => GetMessage("STORES_FILTER_PARAM_STORE_TITLE"),
			"SHOP" => GetMessage("STORES_FILTER_PARAM_SHOP_TITLE"),
			"SHINMONTAG" => GetMessage("STORES_FILTER_PARAM_SHINMONTAG_TITLE"),
			"PUNKT_VYDACHI" => GetMessage("STORES_FILTER_PARAM_PUNKT_VYDACHI_TITLE"),
		),
		"PARENT" => "STORE_SETTINGS",
		'MULTIPLE' => 'Y',
	),
...
$arTemplateParameters['LIST_PRODUCT_BLOCKS_TAB_ORDER'] = array(
	...
	'JS_DATA' => Json::encode(array(
		...
		'buy' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_BUY'),
		'cash' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_CASH'),
		'delivery' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_DELIVERY'),
		'available' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_AVAILABLE'),
		'video' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_VIDEO'),
		'reviews' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_REVIEWS'),
		'suitable' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_SUITABLE'),
		'question' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_QUESTION'),
		'dop' => GetMessage('CP_BC_TPL_PRODUCT_BLOCK_DOP'),
	)),
	'DEFAULT' => 'offers,desc,char,buy,cash,delivery,available,video,reviews,suitable,question,dop'
);	
?>
