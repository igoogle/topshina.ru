...
?><div class="inside_page_content">
 ...
 <br>
	<div>
		В разделе "<a href="<?=SITE_DIR?>articles/">Статьи</a>" Вы найдете интересные материалы о способах обращения с техникой, оптимальных способах использования строительных материалов и многих других вещах, которые позволят Вам быстрее выбрать нужный товар и как можно легче его использовать.
	</div>
 <br>
	<div>
