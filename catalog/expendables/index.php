...
$APPLICATION->SetPageProperty("PODBOR_TITLE", "Подбор расходников");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"LIST_PROPERTY_CODE" => array(
			...
			8 => "VYSOTA_PROFILYA",
			9 => "DESCRIPTION",
			10 => "POSADOCHNYY_DIAMETR",
			11 => "SEZONNOST",
			12 => "SHIRINA_PROFILYA",
			13 => "SHIPY",
			14 => "MEZHBOLTOVOE_RASSTOYANIE",
			15 => "POSADOCHNYY_DIAMETR_DISKA",
			16 => "SHIRINA_DISKA",
			17 => "NEW",
			18 => "SPIKES",
			19 => "FILES",
