...
$APPLICATION->SetPageProperty("PODBOR_TITLE", "Подбор аккумуляторов");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FILTER_URL" => $arTheme["CATALOG_AKB_PAGE_URL"]["VALUE"],
		"TYPE" => "akb",
		...
		"USE_SUITABLE_CAR" => "Y",
		"TAB_SUITABLE_NAME" => "",
		"SEF_URL_TEMPLATES_FILTER" => "#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/",
