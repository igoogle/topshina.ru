...
if($arMenuParametrs = CTires2::GetDirMenuParametrs(__DIR__))
{
	...
	{
		$catalog_code = 'aspro_tires2_catalog_tires';
		$catalog_id = \Bitrix\Main\Config\Option::get('aspro.tires2', 'CATALOG_TIRES_IBLOCK_ID', CTires2Cache::$arIBlocks[SITE_ID]['aspro_tires2_catalog'][$catalog_code][0]);
