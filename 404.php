...
?>
<style>.right_block.wide_, .right_block.wide_N{float:none !important;width:100% !important;}body .wrapper_inner.wide_page > .middle.error-page div.maxwidth-theme{padding-top:0;padding-bottom:0;</style>
<div class="maxwidth-theme">
	<div class="page_error_block">
		<table class="page_not_found" width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="image">
					<svg width="100%" height="150%" viewBox="0 0 554.66 225.907">
					  <defs>
					    <style>
					      .cls-1 {
					        fill-rule: evenodd;
				...
				<td class="description">
					...
					<div class="button_main"><a class="btn btn-default btn-lg" href="<?=SITE_DIR?>"><span>Перейти на главную</span></a></div>
